...
contract TestAggregates is Setup {
    ...
    function test_TotalAssetsIncreaseAfterDepositBuyOrder() public {
        ...
        assertEq(book.getTimeWeightedRate(BuyOrder), buyOrderTimeWeightedRate + (DAY - 1) * buyOrderinstantRate / YEAR);
        assertEq(book.getTimeWeightedRate(SellOrder), sellOrderTimeWeightedRate + (DAY - 1) * sellOrderinstantRate / YEAR);
    ...
    function test_TotalBorrowIncreaseAfterBorrowBuyOrder() public {
        ...
        assertEq(book.getTimeWeightedRate(BuyOrder), buyOrderTimeWeightedRate + 2 * DAY * buyOrderinstantRate / YEAR);
        assertEq(book.getTimeWeightedRate(SellOrder), sellOrderTimeWeightedRate + 2 * DAY * sellOrderinstantRate / YEAR);
        assertEq(book.totalQuoteAssets(), totalQuoteAssets);
        assertEq(book.totalBaseAssets(), totalBaseAssets);
    ...
    function test_TotalBorrowDecreaseAfterRepayBuyOrder() public {
        ...
        checkInstantRate(BuyOrder);
        checkInstantRate(SellOrder);
        assertEq(book.getTimeWeightedRate(BuyOrder), buyOrderTimeWeightedRate + 365 * DAY * buyOrderinstantRate / YEAR);
        assertEq(book.getTimeWeightedRate(SellOrder), sellOrderTimeWeightedRate + 365 * DAY * sellOrderinstantRate / YEAR);
        assertEq(book.totalQuoteAssets(), totalQuoteAssets);
        assertEq(book.totalBaseAssets(), totalBaseAssets);
